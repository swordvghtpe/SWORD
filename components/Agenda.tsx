...
const amAgendaEn: AgendaItem[] = [
  ...
  { time: '10:30-10:50', title: 'Update on treatment for olfactory dysfunction', speaker: 'Prof. Rong-Shan Jiang\n(Dr. Man-Wei Hua)', moderator: 'Prof. Ming-Ying Lan' },
...
const amAgendaZh: AgendaItem[] = [
  ...
  { time: '10:00-10:10', title: 'Discussion' },
  { time: '10:10-10:30', title: 'Coffee break', isBreak: true },
  { time: '10:30-10:50', title: 'Update on treatment for olfactory dysfunction', speaker: '江榮山 教授\n(花曼瑋 醫師代)', moderator: '藍敏瑛 教授' },
                ...
                <div className="mt-2 md:mt-0 md:text-right flex-shrink-0 md:ml-4 space-y-2">
                    {item.speaker && (
                        <div className="text-gray-800 font-medium">
                            ...
                            <span className="block text-xs md:text-base whitespace-pre-line">{item.speaker}</span>
                        </div>
                    )}
                    {item.moderator && (
